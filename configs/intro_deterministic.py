...
### Experimentname
NAME_EXPERIMENT: str = "intro-deterministic"

### Algorithm
ALGORITHM_NAME: str =  "IE mixed FEM Strato Transport with div-sym additive" #see src.algorithms.select.py for available choices
