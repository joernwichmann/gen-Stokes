...
if __name__=="__main__":
    ...
    for noise in cf.NOISE_TYPES:
        ...
        if cf.LINEAR_PLOT:
            ...
            plt.vlines(x=cf.STATIONARY_ENERGY,ymin=0,ymax=cf.YMAX[noise],colors="black",linestyles="solid")
    ...
    if cf.LINEAR_PLOT:
        ...
        for noise in cf.NOISE_TYPES:
            sns.histplot(all_data[noise], bins="auto", stat="probability", kde=True, color=cf.COLOURS_MEAN[noise], log_scale=(True,False))
        plt.xlabel("Kinetic energy")
        plt.vlines(x=cf.STATIONARY_ENERGY,ymin=0,ymax=cf.YMAX["intro-additive"],colors="black",linestyles="solid")
        plt.tight_layout()
